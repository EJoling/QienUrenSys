...
// Variabelen aanmaken om uren in bij elkaar op te tellen
...
// function tabelMaken(tabelNaam, tabelLengte, IDcel){
// 	console.log("check in tabelMaken");
// 	var table = document.getElementById(tabelNaam);
// 	var insertedRow = table.insertRow(2);
//     insertedRow.className = "declaratiesRow";
 
// 	for(var i = 0; i<tabelLengte; i++){
// 		//maak cel aan
